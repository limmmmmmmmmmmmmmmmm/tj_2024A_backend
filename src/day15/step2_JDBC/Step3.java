    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            try {
                ...
                if (ch==1){
                    //1. 입력받고
                    System.out.println(">>저장할 이름 : "); String name = scan.next();
                    //2.DB 저장
                    ...
                    System.out.println("수정[U] 기존이름 : "); String oldName = scan.next();
                    System.out.println("수정[U] 새로운이름 : "); String newName = scan.next();
                ...
                System.out.println("SQL 구문이 틀렸습니다.");
            }

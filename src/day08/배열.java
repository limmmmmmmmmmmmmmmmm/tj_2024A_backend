...
public class 배열 {
    ...
    7. 배열의 항목/요소 값 호출
        배열변무셩[인덱스]
    8. 배열 항목 값 초기화/비우기
        배열변수명[인덱스] = 각 타입의 초기값 ex) 0,  0.0 , null
            -한번 할당된 배열의 길이는 다시 할당(new) 되기전까지 고정길이
